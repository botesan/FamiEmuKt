...
fun Cartridge(backupRAM: BackupRAM, iNesData: ByteArray): Cartridge {
...
@OptIn(ExperimentalUnsignedTypes::class)
private class CartridgeImpl(
    override val information: Cartridge.Information,
    override val backupRAM: BackupRAM,
    private val prgRom: UByteArray,
    private val chrRom: UByteArray
) : Cartridge {
    override val mapper: Mapper by lazy { Mapper.create(cartridge = this, prgRom = prgRom, chrRom = chrRom) }

    data class Information(
        override val prgRom16Units: Int,
        override val chrRom8Units: Int,
        override val mirroringVertical: Boolean,
        override val batteryBackup: Boolean,
        override val trainer: Boolean,
        override val ignoreMirroring: Boolean,
        override val vsUniSystem: Boolean,
        override val playChoice10: Boolean,
        override val isNES20: Boolean,
        override val mapperNo: Int,
        override val subMapperNo: Int?,
        override val rpgRam8Units: Int,
        override val isNTSC: Boolean,
        override val isPrgRamPresent: Boolean,
        override val isHasBusConflicts: Boolean,
